...
function About() {
    return (
        <div id="about-crelo">
            ...
            <section>
                <h2>How It Works</h2>
                <p><span className="coloured-text">Sign up to start pledging!</span> We won't send you any annoying emails. We won't even chase you for the money (because, you know, this whole website is fake). It's risk-free pledging! Go nuts!</p>
